...
st.markdown(
    ...
    <div style="display:flex; justify-content:center; align-items:center; gap:5px; padding: 10px 0;">
        <h1 style="margin-bottom:0;"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/notion/notion-line.svg" width="58" style="margin-bottom: 0.7em;" /> NotionAtlas AI</h1>
    </div>
